...
void main() {
	...
	if ( !GetIsObjectValid(GetItemPossessedBy(OBJECT_SELF, "FishingBait")) ) {
		FloatingTextStringOnCreature("Ohne Köder ist Angeln eine wenig einträgliche Tätigkeit.", OBJECT_SELF,
			FALSE);
		return;
	}
