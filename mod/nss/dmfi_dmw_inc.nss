...
string dmwand_Alignment(object oEntity) {
	...
	switch ( GetAlignmentGoodEvil(oEntity) ) {
		...
		case ALIGNMENT_EVIL:   sReturnString = sReturnString +  "Böse";  break;
	}
...
void dmwand_SkillCheck(int nSkill, int nSecret = TRUE) {
	...
	switch ( nSkill ) {
		case SKILL_ANIMAL_EMPATHY:
			sSkill = "Gefühl für Tiere"; break;
		case SKILL_CONCENTRATION:
			sSkill = "Konzentration"; break;
		case SKILL_DISABLE_TRAP:
			sSkill = "Fallen entschärfen"; break;
		...
		case SKILL_OPEN_LOCK:
			sSkill = "Schlösser öffnen"; break;
		case SKILL_PARRY:
			sSkill = "Parrieren"; break;
		case SKILL_PERFORM:
			sSkill = "Auftreten"; break;
		case SKILL_PERSUADE:
			sSkill = "Überzeugen"; break;
...
void dmwand_Toad() {
	...
	SendMessageToPC(oMySpeaker, "Penguin?  Du meintest nicht Kröte?");
...
int dmw_conv_ChangeAlign(int nCurrent, int nChoice, string sParams = "") {
	...
	switch ( nCurrent ) {
		case 0:
			nCurrent = 0;
			sText =       "In welche Richtung willst du ändern?";
			sCall =       "";
			sCallParams = "";
			break;
		case 1:
...
int dmw_conv_Inventory(int nCurrent, int nChoice, string sParams = "") {
	...
	switch ( nCurrent ) {
		...
		case 3:
			nCurrent = 3;
			sText =       "Alle ausgerüsteten Items nehmen.";
			sCall =       "func_TakeAllEquipped";
			sCallParams = "";
			break;
		case 4:
			nCurrent = 4;
			sText =       "Alle unausgerüsteten Items nehmen.";
...
int dmw_conv_ModRep(int nCurrent, int nChoice, string sParams = "") {
	...
	switch ( nCurrent ) {
		case 0:
			nCurrent = 0;
			sText =       "Wie stark die Reputation ändern?";
			sCall =       "";
			sCallParams = "";
			break;
		case 1:
