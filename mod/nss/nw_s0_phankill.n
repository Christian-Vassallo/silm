...
int MySavingThrow2(int nSavingThrow, object oTarget, int nDC, int nSaveType = SAVING_THROW_TYPE_NONE, object oSaveVersus = OBJECT_SELF,
				   float fDelay = 0.0);
...
// End of Spell Cast Hook
	...
	if ( !GetIsReactionTypeFriendly(oTarget) ) {
		...
		if ( !MyResistSpell(OBJECT_SELF, oTarget) ) {
			...
			if ( !MySavingThrow2(SAVING_THROW_WILL,  oTarget, ( METAMAGIC_EMPOWER == nMetaMagic ? 4 : 0 ) +
					GetSpellSaveDC(), SAVING_THROW_TYPE_MIND_SPELLS) ) {
