...
void stomachStarvation(object oPC, int iRank) {
	...
	switch ( iRank ) {
		case 1:
			// Kaum Hunger
			switch ( iRandApp ) {
				case  1: FloatingTextStringOnCreature("Ihr habt ein leichtes Hungergefühl.", oPC, FALSE);
					break;
				case  2: FloatingTextStringOnCreature("Euch dürstet es ein wenig.", oPC, FALSE); break;
				case  3: FloatingTextStringOnCreature(
						"Kurz schweifen eure Gedanken darum was wohl eure nächste Mahlzeit sein wird.", oPC,
						FALSE); break;
				case  4: FloatingTextStringOnCreature(
						"Zaghaft meldet sich euer Magen: Eine kleine Knabberei käme wohl gelegen.", oPC,
						FALSE); break;
		...
		case 2:
			...
			switch ( iRandApp ) {
				...
				case  2: FloatingTextStringOnCreature("Hunger und Durst machen stark auf sich aufmerksam.",
						oPC, FALSE); break;
				case  3: FloatingTextStringOnCreature(
						"Immer häufiger schweifen Eure Gedanken zum leeren Gefühl in der Magengegend.", oPC,
						FALSE); break;
				case  4: FloatingTextStringOnCreature("Ihr verspürt schlicht und einfach Hunger.", oPC, FALSE);
					break;
		...
		case 3:
			...
			switch ( iRandApp ) {
				...
				case  2: FloatingTextStringOnCreature(
					...
					break;
				case  3: FloatingTextStringOnCreature(
						"Ihr fühlt Euch recht matt, als es Euren Körper nach Nahrung verlangt!", oPC, FALSE);
					break;
				case  4: AssignCommand(oPC, SpeakString("*Es rummort hörbar, offensichtlich vor Hunger*",
							TALKVOLUME_WHISPER)); break;
			...
			switch ( iRandApp ) {
				case  1:
					FloatingTextStringOnCreature(
						"Ihr fühlt Euch immer schwächer als Euer Körper versucht mit dem Nahrungsentzug zurecht zu kommen.",
						oPC, FALSE);
				...
				case  2:
					FloatingTextStringOnCreature(
						"Unzureichende Ernährung lässt Euch die Hand nicht mehr sicher führen und Eure Finger zittern leicht.",
						oPC, FALSE);
					ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectAbilityDecrease(ABILITY_DEXTERITY,
							Random(2) + 1), oPC, 900.0f);
					break;
				case  3:
					FloatingTextStringOnCreature("Der Nahrungsentzug greift Euren Körper an.", oPC, FALSE);
					ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectAbilityDecrease(ABILITY_CONSTITUTION,
							Random(2) + 1), oPC, 900.0f);
					break;
				case  4:
					FloatingTextStringOnCreature(
						"Durch mangelnde Ernährung fehlt Euch die Energie und ihr fühlt Euch im Ganzen dadurch recht schlaff.",
						oPC, FALSE);
					ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectAbilityDecrease(ABILITY_CONSTITUTION,
							Random(2) + 1), oPC, 900.0f);
					break;
				case  5:
					FloatingTextStringOnCreature(
						"Durch mangelndes Essen, könnt ihr Eure Gedanken nun nicht mehr richtig lenken und das Konzentrieren fällt schwer.",
						oPC, FALSE);
