 ...
 * } */
// Andeuten das hier sowohl Fisch als auch klares Wasser verfügbar scheint
	switch ( Random(4) + 1 ) {
		case 5:
			FloatingTextStringOnCreature(
				"Im klaren Wasser könnt ihr einige Fische ausmachen die sich munter tummeln.", oPC, FALSE);
			break;
		case 4:
			FloatingTextStringOnCreature(
		...
		case 2:
			...
			break;
		case 1:
			FloatingTextStringOnCreature("So reines und klares Wasser läd direkt zum trinken ein.", oPC,
				FALSE);
			break;
		default:
			break;
