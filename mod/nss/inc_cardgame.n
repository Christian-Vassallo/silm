...
void StartGame() {
	...
	object oCardStack = CreateObject(OBJECT_TYPE_PLACEABLE, "dmfi_cardstack", GetLocation(OBJECT_SELF), FALSE);
	...
	for ( i = 1; i <= iPlayerCount; i++ ) {
		...
		GiveGoldToCreature(oPlayer, Money2Value(CountCreatureMoney(oPlayer, TRUE)));
...
//Sucht nach dem naechsten Spieler der noch einen Zug machen darf
	for ( i = 1; i <= iPlayerCount; i++ ) {
		...
		if ( oNextPlayer == OBJECT_SELF ) {
			switch ( iGame ) {
				case 0: ShowResults(oCardStack); return;
			...
			case 0: //Poker
				{
					...
					if ( iCardValue > 0 ) {
						...
						for ( i = iStart; i < 5; i++ ) {
							...
							switch ( iEquals ) {
								case 0: iCardValue = StringToInt(sCard) % 13; break;
								case 1: iPaar++;
									{
										...
										if ( iNewCardValue <
											...
											switch ( iNewCardValue ) {
												case 9:  sCombination += sCard10a; break;
												case 10:  sCombination += sCard11a; break;
												case 11:  sCombination += sCard12a; break;
												case 12:  sCombination += sCard13a; break;
											}
										}
								...
								case 2: iTrio = TRUE;
									...
									if ( iCardValue <
										...
										switch ( iCardValue ) {
											case 9:  sCombination += sCard10b; break;
											case 10:  sCombination += sCard11b; break;
											case 11:  sCombination += sCard12b; break;
											case 12:  sCombination += sCard13b; break;
										}
									}
								...
								case 3:
									...
									if ( iCardValue <
										...
										switch ( iCardValue ) {
											case 9:  sCombination += sCard10c; break;
											case 10:  sCombination += sCard11c; break;
											case 11:  sCombination += sCard12c; break;
											case 12:  sCombination += sCard13c; break;
										}
									}
									break;
								default: break;
...
*******************************************************************************/
	...
	ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(322), getPlayer(oCardStack, iActivePlayer));
	...
	switch ( iGame ) {
		case 0: //Poker
			...
			switch ( iDiscardCount ) {
				case 0: SetCustomToken(9006, "keine Karte"); break;
				case 1: SetCustomToken(9006, "1 Karte  fuer " + sValue); break;
				default: SetCustomToken(9006, IntToString(iDiscardCount) + " Karten fuer " + sValue);
			}
...
string getCardString(string sCard, int iPictureOnly = FALSE) {
	...
	switch ( card % 13 ) {
		case 0: sCardName = sCardName + sCard1; break;
		case 1: sCardName = sCardName + sCard2; break;
		case 2: sCardName = sCardName + sCard3; break;
		case 3: sCardName = sCardName + sCard4; break;
		case 4: sCardName = sCardName + sCard5; break;
		case 5: sCardName = sCardName + sCard6; break;
		case 6: sCardName = sCardName + sCard7; break;
		case 7: sCardName = sCardName + sCard8; break;
		case 8: sCardName = sCardName + sCard9; break;
		case 9: sCardName = sCardName + sCard10; break;
		case 10: sCardName = sCardName + sCard11; break;
		case 11: sCardName = sCardName + sCard12; break;
		case 12: sCardName = sCardName + sCard13;
	}
...
void resetGame(object oCardStack) {
	...
	for ( i = 1; i <= 5; i++ ) {
		...
		if ( oPlayer != OBJECT_INVALID ) {
			...
			GiveValueToCreature(oPlayer, iValue);
