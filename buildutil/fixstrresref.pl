...
#	  Last Modification : 07:26 Feb  3 2007 kivinen
#	  Last check in     : $Date: 2007/02/03 05:26:47 $
...
foreach $i (@ARGV) {
    ...
    update_str_resref($gff, 'DescIdentified');
    update_str_resref($gff, 'Description');
    update_str_resref($gff, 'LocalizedName');
