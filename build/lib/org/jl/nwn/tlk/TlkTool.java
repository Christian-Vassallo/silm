...
*/
	public static void writeTlkFile( List tlkList, File file ) throws IOException{
		writeTlkFile( tlkList, file, NwnLanguage.ENGLISH.getCode() );
	}
	
	public static void writeTlkFile( List tlkList, File file, int language ) throws IOException{
		( new TlkContent( tlkList, NwnLanguage.forCode( language ) ) ).saveAs( file, Version.getDefaultVersion() );
	}
