...
public class GffEditX extends SimpleFileEditorPanelX implements ClipboardOwner {
    ...
    public static final UIDefaultsX uid = new UIDefaultsX();
    
    static {
        uid.addResourceBundle(
                "org.jl.nwn.gff.editor.uidefaults",
                Locale.getDefault(),
                GffEditX.class.getClassLoader());
    ...
    public GffEditX() {
        ...
        // first column is always created automatically :(
        TableColumnExt c0 = (TableColumnExt) treeTable.getColumnModel().getColumn(0);
        ...
        treeTable.getHighlighters().addHighlighter(new AlternateRowHighlighter());
